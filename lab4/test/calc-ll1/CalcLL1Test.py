...
from CalcLL1Grammar import CalcLL1Lexer, CalcLL1Parser
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="CalcLL1 grammar tester")
    ...
    lexer = CalcLL1Lexer(inputStream)
    parser = CalcLL1Parser(lexer)
